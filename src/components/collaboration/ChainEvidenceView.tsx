  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <PageHeader
        ...
        subtitle="Every audit log entry hashed and anchored to Hyperledger Besu / Ethereum Sepia — cryptographic tamper detection. Defensible in court."
        icon={Link2}
          ...
          {selected && (
            <Card className="border-slate-200">
              ...
              <CardContent className="space-y-2 text-xs">
                ...
                <div className="pt-2">
                  <p className="mb-1 text-slate-500">Payload Hash</p>
